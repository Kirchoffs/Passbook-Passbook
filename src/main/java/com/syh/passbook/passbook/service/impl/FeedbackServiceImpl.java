...
import com.syh.passbook.passbook.mapper.FeedbackRowMapper;
...
public class FeedbackServiceImpl implements IFeedbackService {
    ...
    public Response createFeedback(Feedback feedback) {
        if (!feedback.validate()) {
            log.error("Feedback Error: {}", new GsonBuilder().create().toJson(feedback));
    ...
    public Response getFeedback(Long userId) {
        ...
        Scan scan = new Scan().setFilter(new PrefixFilter(reverseUserId));
